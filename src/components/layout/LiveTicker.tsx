...
export function LiveTicker() {
  ...
  return (
    <div className="relative flex items-center gap-4 border-y border-gray-200 bg-gray-50 py-2.5">
      <div className="z-10 flex shrink-0 items-center gap-2 border-r border-gray-200 pl-5 pr-4 md:pl-8">
